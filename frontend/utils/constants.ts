...
export const STYLE_PREVIEWS = {
  ...
  Streetwear: {
    ...
    price: 78,
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAWcDrl9jAZjryqDW3As7n_KRuPZk8GnRWWcBsMBPb_ZdzkSZ-FpemwYzS8L9U4_DOTXwLvfSYuiqFLZaxJf51goGEenHu9wS9-0AZ67ELn2AeFlL_Ng60Nwwuuf20Qk-jkCLLs5IeMcQ0JSPcREv8-claCwd-6Zbp5NEB0N859R8U2QKohjsNJshCHf3JcgCeV91l3EbmmO92LCoG2-VjU11aR-1FdFPiI6Ea5PDRXby79zJYGgYeivE-2GZ4Ma0MX_4PwHac5fQ",
  },
  Abstract: {
...
// Image generation is for signed-in users only; mirrors PRODUCT_IMAGE_GENERATION_LIMIT.
...
export const SHIRT_PATH_FRONT = `M 160,80 C 175,112 225,112 240,80 ${BODY_PATH}`;
export const SHIRT_PATH_BACK = `M 160,80 Q 200,68 240,80 ${BODY_PATH}`;

export const colors = [
  { color: "Black", colorCode: "#000000", image: null },
  { color: "Silver", colorCode: "#c0c0c0", image: null },
  { color: "Grey", colorCode: "#808080", image: null },
