...
const SizeSelector = ({ size, setSize }: Pick<HeroBottomBarProps, "size" | "setSize">) => (
  <div className="space-y-2 flex-shrink-0">
...
const GenderSelector = ({ gender, setGender }: Pick<HeroBottomBarProps, "gender" | "setGender">) => (
  <div className="space-y-2 flex-shrink-0">
...
const HeroBottomBar = ({
  ...
  return (
    <div className="lg:col-span-2 glass-card p-6 flex flex-col sm:flex-row items-center gap-6">
      ...
      <Divider />
      <PlacementSelector placement={placement} setPlacement={setPlacement} />
      <Divider />
