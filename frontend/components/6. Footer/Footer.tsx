            ...
            <Container>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 max-w-container-max mx-auto mb-12">
                    ...
                    <div className="space-y-6">
                        <Link
                            href="/"
                            className="font-display-lg text-headline-xl font-extrabold text-primary tracking-tighter select-none"
                        >
                            AIGEN
                        </Link>
                        <p className="font-body-md text-secondary text-sm max-w-[200px] leading-relaxed">
                            Pioneering the intersection of artificial
                            intelligence and premium streetwear.
                        </p>
                    </div>

                    {/* Shop Links */}
                    <div className="space-y-4">
                        <h4 className="font-label-bold text-xs font-semibold text-primary uppercase tracking-[0.15em]">
                            COLLECTIONS
                        </h4>
                        <nav className="flex flex-col gap-2">
                            <Link
                                href="#"
                                className="font-body-md text-sm text-secondary hover:text-primary transition-all"
                            >
                                New Arrivals
                            </Link>
                            <Link
                    ...
                    <div className="space-y-4">
                        ...
                        <form
                            ...
                            className="flex bg-white/60 backdrop-blur rounded-full p-1 border border-white/40"
                        >
                            <input
                                type="email"
                                value={email}
                ...
                <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/20 gap-4">
                    <p className="font-body-md text-sm text-secondary">
                        &copy; {new Date().getFullYear()} AIGEN Studio. High
                        Resolution Art.
                    </p>
