...
from exceptions.outbox_event_exceptions import OutboxEventCreationError, OutboxEventNotFoundError, OutboxEventUpdateError


class OutboxEventService:
    """Service for handling outbox events in supplier_service."""
