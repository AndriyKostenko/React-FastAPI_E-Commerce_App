"""wishlist-service ASGI entrypoint.
...
specific to wishlist-service.
"""

from uvicorn import run

from app_config import DESCRIPTOR, resolve_resources, wishlist_service_lifespan
...
app = (
    ServiceAppBuilder[WishlistApiResources](DESCRIPTOR, settings=settings, logger=logger)
    .with_lifespan(wishlist_service_lifespan, resolve_resources)
    .with_readiness(DatabaseEngineProbe())
    .with_router(wishlist_routes, prefix=DESCRIPTOR.api_prefix)
    .build()
)
