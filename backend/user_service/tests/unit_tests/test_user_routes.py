...
Uses httpx.Asyncclient_for_unit_testing: AsyncClient + ASGITransport to send real HTTP requests through
...
class TestRegisterEndpoint:
    async def test_register_success(self, client_for_unit_testing: AsyncClient):
        response = await client_for_unit_testing.post(f"{test_settings.API}/register", json=test_settings.REGISTER_PAYLOAD)
        assert response.status_code == 201
        body = response.json()
        assert body["email"] == "test@example.com"

    async def test_register_duplicate_email_returns_409(self, client_for_unit_testing: AsyncClient, mock_route_service):
    ...
    async def test_register_invalid_payload_returns_422(self, client_for_unit_testing: AsyncClient):
        response = await client_for_unit_testing.post(f"{test_settings.API}/register", json={"name": "x"})
...
class TestVerifyEmailEndpoint:
    ...
    async def test_verify_email_invalid_token_returns_404(self, client_for_unit_testing: AsyncClient, mock_route_service):
...
class TestResetPasswordEndpoint:
    ...
    async def test_reset_password_invalid_token_returns_404(self, client_for_unit_testing: AsyncClient, mock_route_service):
...
class TestLoginEndpoint:
    async def test_login_success(self, client_for_unit_testing: AsyncClient):
        response = await client_for_unit_testing.post(f"{test_settings.API}/login", data=test_settings.LOGIN_DATA)
    ...
    async def test_login_invalid_credentials_returns_401(self, client_for_unit_testing: AsyncClient, mock_route_service):
    ...
    async def test_login_missing_fields_returns_422(self, client_for_unit_testing: AsyncClient):
        response = await client_for_unit_testing.post(f"{test_settings.API}/login", data={"username": "only-username"})
...
class TestRefreshTokenEndpoint:
    async def test_refresh_token_success(self, client_for_unit_testing: AsyncClient):
        response = await client_for_unit_testing.post(
    ...
    async def test_refresh_token_invalid_returns_401(self, client_for_unit_testing: AsyncClient, mock_route_service):
...
class TestLogoutEndpoint:
    async def test_logout_success(self, client_for_unit_testing: AsyncClient):
        response = await client_for_unit_testing.post(
...
class TestGetMeEndpoint:
    async def test_get_me_returns_current_user(self, client_for_unit_testing: AsyncClient):
        # get_current_user is overridden in the client_for_unit_testing: AsyncClient fixture to return _CURRENT_USER
...
class TestGetUserByIdEndpoint:
    async def test_get_user_by_id_success(self, client_for_unit_testing: AsyncClient):
        response = await client_for_unit_testing.get(f"{test_settings.API}/users/{test_settings.TEST_USER_ID}")
        assert response.status_code == 200
        body = response.json()
        assert body["email"] == "test@example.com"

    async def test_get_user_by_id_not_found_returns_404(self, client_for_unit_testing: AsyncClient, mock_route_service):
...
class TestUpdateUserEndpoint:
    async def test_update_user_success(self, client_for_unit_testing: AsyncClient):
    ...
    async def test_update_user_not_found_returns_404(self, client_for_unit_testing: AsyncClient, mock_route_service):
...
class TestDeleteUserEndpoint:
    async def test_delete_user_success(self, client_for_unit_testing: AsyncClient):
        response = await client_for_unit_testing.delete(f"{test_settings.API}/users/{test_settings.TEST_USER_ID}")
        assert response.status_code == 200
        assert response.json()["detail"] == "User deleted successfully"

    async def test_delete_user_not_found_returns_404(self, client_for_unit_testing: AsyncClient, mock_route_service):
