"""How order-service fills in the shared application builder.
...
from resources import order_api_runtime, get_order_api_resources
...
DESCRIPTOR = ServiceDescriptor(
    ...
    title="order-service",
    description=(
        "This is an order service for managing customer orders and production runs."
    ),
    api_prefix=settings.ORDER_SERVICE_URL_API_VERSION,
...
resolve_resources = get_order_api_resources


@asynccontextmanager
async def order_service_lifespan(app: FastAPI) -> AsyncIterator[None]:
