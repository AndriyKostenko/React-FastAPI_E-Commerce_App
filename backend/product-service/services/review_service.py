...
from schemas.review_schemas import CreateReview
...
class ReviewCRUDService:
    ...
    async def create_product_review(self, review: CreateReview) -> ProductReview:
    ...
    async def get_review_by_id(self, review_id: UUID) -> ProductReview | None:
    ...
    async def get_product_review_by_user_id(self, product_id: UUID, user_id: UUID) -> ProductReview | None:
    ...
    async def update_product_review(self, review_id: UUID, update_data: CreateReview) -> ProductReview:
