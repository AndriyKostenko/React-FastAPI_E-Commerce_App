...
import { ApiResourceProvider } from 'src/resources/api-resource-provider.js';
...
const options = {
    ...
    resources: [
        {
            resource: new ApiResourceProvider(`${process.env.API_GATEWAY_SERVICE_URL}${process.env.API_GATEWAY_SERVICE_URL_API_VERSION}/users`, 'User'),
            options: {
                navigation: {
