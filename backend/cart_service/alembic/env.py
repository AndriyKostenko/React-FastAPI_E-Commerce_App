...
config.set_main_option("sqlalchemy.url", settings.CART_SERVICE_DATABASE_URL)
...
async def run_migrations_online() -> None:
    ...
    database_url = config.get_main_option("sqlalchemy.url") or settings.CART_SERVICE_DATABASE_URL
