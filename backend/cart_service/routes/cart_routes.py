...
async def get_cart(caller: SelfOrAdminDep, request: Request, user_id: UUID, cart_service: cart_service_dependency) -> CartSchema:
...
@cart_routes.get("/users/{user_id}/cart/summary",
                 ...
                 status_code=status.HTTP_200_OK)
async def get_cart_summary(caller: SelfOrAdminDep, request: Request, user_id: UUID, cart_service: cart_service_dependency) -> CartSummary:
...
@cart_routes.post("/users/{user_id}/cart/items",
                  response_model=CartSchema,
                  status_code=status.HTTP_200_OK)
async def add_item_to_cart(caller: SelfOrAdminDep, request: Request, user_id: UUID, item_data: AddCartItem, cart_service: cart_service_dependency) -> CartSchema:
...
@cart_routes.put("/users/{user_id}/cart/items/{item_id}",
                 response_model=CartSchema,
                 status_code=status.HTTP_200_OK)
async def update_cart_item(caller: SelfOrAdminDep, request: Request, user_id: UUID, item_id: UUID, item_data: UpdateCartItem, cart_service: cart_service_dependency) -> CartSchema:
...
@cart_routes.delete("/users/{user_id}/cart/items/{item_id}",
                    response_model=CartSchema,
                    status_code=status.HTTP_200_OK)
async def remove_cart_item(caller: SelfOrAdminDep, request: Request, user_id: UUID, item_id: UUID, cart_service: cart_service_dependency) -> CartSchema:
...
async def clear_cart(caller: SelfOrAdminDep, request: Request, user_id: UUID, cart_service: cart_service_dependency) -> None:
